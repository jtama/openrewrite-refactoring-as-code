...
Readable version available on https://jtama.github.io/openrewrite-refactoring-as-code/[Github Pages -> ici]
...
----
cd slides
jbang qrcode@maxandersen https://jtama.github.io/openrewrite-refactoring-as-code/devquest/home.html -o images/qr_home.png -i slides/images/magic/feedback.png
