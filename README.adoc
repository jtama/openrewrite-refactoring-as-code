...
----
cd slides
jbang qrcode@maxandersen -i images/feedback.png https://openfeedback.io/debug-refacto-pattern-matching-level-up-ton-code-java/0/Jc68GIfKguprKWCMna9E -o images/qrcode_feedback.png -d 120:120
