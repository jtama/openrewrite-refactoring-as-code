...
----
cd slides
jbang qrcode@maxandersen -i images/feedback.png https://openfeedback.io/w3JorGi7ut6d9keUsCvO/2025-02-06/cm1625fjo00dd1bi2r2yqzotb -o images/qrcode_feedback.png -od 120:120
