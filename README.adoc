...
----
cd slides
jbang qrcode@maxandersen https://openfeedback.io/devfestnantes2025/2025-10-16/openrewriterefactorascode -i images/magic/feedback.webp -o images/feedback.png
